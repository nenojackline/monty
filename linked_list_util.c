...
/**
 * fnQueueNode - adds a node to a stack_t stack in queue node
 * @stack: stack head
...
/**
 * fnAddNode - adds a node to the start of a stack_t stack
 * @stack: stack head
...
/**
 * fnPrintStack - prints the contents of a stack_t stack
 * @stack: stack head
 *
...
/**
 * fnFreeStack - frees a dlistint_t linked list
 * @stack: list head
 *
 * Return: void
 */
